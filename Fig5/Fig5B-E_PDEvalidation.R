...
des_cond = "aOSM"  # PTPN22i, aOSM

# define path  - data is %
des_sheet = c("GZMB_NonTregs", "HLA-DR_NonTregs", "Ki67_NonTregs", "OX40_NonTregs", 
              "41BB_CD8", "GZMB_CD8", "HLA-DR_CD8", "Ki67_CD8", "OX40_CD8", "PD1_CD8",  # "CD39_CD8",
...
#colours = c("#00AFBB", "red")
#colours = c("#685968", "#55868c")
colours = c("#685968", "#E96279")  # for PTPN22
